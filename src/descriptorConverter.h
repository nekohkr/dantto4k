...
constexpr static uint8_t convertAudioSamplingRate(uint8_t samplingRate) {
    switch (samplingRate) {
    case 0b010: // 24 kHz
        return 0b010;
    case 0b101: // 32 kHz
...
constexpr static uint8_t convertVideoComponentType(uint8_t videoResolution, uint8_t videoAspectRatio) {
