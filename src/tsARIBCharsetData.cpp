...
const ts::ARIBCharset2::CharMap* const ts::ARIBCharset2::ALL_MAPS[] = {
...
const ts::ARIBCharset2::CharMap ts::ARIBCharset2::UNSUPPORTED_1BYTE = {
...
const ts::ARIBCharset2::CharMap ts::ARIBCharset2::UNSUPPORTED_2BYTE = {
    true,  // 2-byte charset
    false, // Not macro
    0x00,
    0x00,
...
const ts::ARIBCharset2::CharMap ts::ARIBCharset2::MACRO_MAP = {
    false, // 1-byte charset
...
const ts::ARIBCharset2::CharMap ts::ARIBCharset2::ALPHANUMERIC_MAP = {
    false, // 1-byte charset
    false, // Not macro
...
const ts::ARIBCharset2::CharRow ts::ARIBCharset2::ALPHANUMERIC_ROW = {
...
const ts::ARIBCharset2::CharMap ts::ARIBCharset2::HIRAGANA_MAP = {
    false, // 1-byte charset
    false, // Not macro
...
const ts::ARIBCharset2::CharRow ts::ARIBCharset2::HIRAGANA_ROW = {
...
const ts::ARIBCharset2::CharMap ts::ARIBCharset2::KATAKANA_MAP = {
    false, // 1-byte charset
    false, // Not macro
...
const ts::ARIBCharset2::CharRow ts::ARIBCharset2::KATAKANA_ROW = {
    ...
    0x30F1, 0x30F2, 0x30F3, 0x30F4, 0x30F5, 0x30F6, 0x309D, 0x309E,
    0x30FC, 0x3002, 0x300C, 0x300D, 0x3001, 0x30FB,
};

const ts::ARIBCharset2::CharMap ts::ARIBCharset2::JIS_X0201_KATAKANA_MAP = {
    false, // 1-byte charset
    false, // Not macro
...
const ts::ARIBCharset2::CharRow ts::ARIBCharset2::JIS_X0201_KATAKANA_ROW = {
...
const ts::ARIBCharset2::CharMap ts::ARIBCharset2::KANJI_STANDARD_MAP = {
    true,  // 2-byte charset
    false, // Not macro
...
const ts::ARIBCharset2::CharRow ts::ARIBCharset2::KANJI_BASE_ROWS[86] = {
    { // Row 1 (index 0)
    ...
    // Rows 9 to 15 (index 8 to 14) are empty.
    {}, {}, {}, {}, {}, {}, {},
    { // Row 16 (index 15)
...
const ts::ARIBCharset2::CharRow ts::ARIBCharset2::KANJI_STANDARD_ROWS[5] = {
    { // Row 90 (index 89)
    ...
    { // Row 94 (index 93)
        ...
        0x02168, 0x02169, 0x0216A, 0x0216B, 0x02470, 0x02471, 0x02472, 0x02473,
        0x02474, 0x02475, 0x02476, 0x02477, 0x02478, 0x02479, 0x0247A, 0x0247B,
        0x0247C, 0x0247D, 0x0247E, 0x0247F, 0x03251, 0x03252, 0x03253, 0x03254,
        ...
        0x1F128, 0x1F129, 0x03255, 0x03256, 0x03257, 0x03258, 0x03259, 0x0325A,
        ...
        0x02776, 0x02777, 0x02778, 0x02779, 0x0277A, 0x0277B, 0x0277C, 0x0277D,
        0x0277E, 0x0277F, 0x024EB, 0x024EC, 0x0325B,
    },
};

// Last 5 rows of the ARB STD-B24 defined Kanji character map with additional characters.
const ts::ARIBCharset2::CharRow ts::ARIBCharset2::KANJI_ADDITIONAL_ROWS[5] = {
    { // Row 90 (index 89)
        ...
        0x1F17F, 0x1F18A, 0x026D0, 0x026D0, 0x026D6, 0x026D7, 0x026D8, 0x026D9,
        0x026DA, 0x026DB, 0x026DC, 0x026DD, 0x026DE, 0x026DF, 0x026E0, 0x026E1,
        0x02B55, 0x03248, 0x03249, 0x0324A, 0x0324B, 0x0324C, 0x0324D, 0x0324E,
        0x0324F, 0x026D0, 0x026D0, 0x026D0, 0x026D0, 0x02491, 0x02492, 0x02493,
        ...
        0x02B1B, 0x02B24, 0x1F217, 0x1F218, 0x1F219, 0x1F21A, 0x1F21B, 0x026BF,
        0x1F21C, 0x1F21D, 0x1F21E, 0x1F21F, 0x1F220, 0x1F221, 0x1F222, 0x1F223,
        0x1F224, 0x1F225, 0x1F14E, 0x03299, 0x1F200,
    },
    { // Row 91 (index 90)
        /* SP */ 0x026E3, 0x02B56, 0x02B57, 0x02B58, 0x02B59, 0x02613, 0x0328B,
    ...
    { // Row 92 (index 91)
        /* SP */ 0x027A1, 0x02B05, 0x02B06, 0x02B07, 0x02B2F, 0x02B2E, 0x05E74,
    ...
    { // Row 93 (index 92)
        /* SP */ 0x0322A, 0x0322B, 0x0322C, 0x0322D, 0x0322E, 0x0322F, 0x03230,
    ...
    { // Row 94 (index 93)
        /* SP */ 0x02160, 0x02161, 0x02162, 0x02163, 0x02164, 0x02165, 0x02166,
...
const ts::ARIBCharset2::PredefMacro ts::ARIBCharset2::PREDEF_MACROS[PREDEF_MACRO_COUNT] = {
    ...
    /* 63 */ {16, {0x1B, 0x28, 0x32, 0x1B, 0x29, 0x34, 0x1B, 0x2A, 0x35, 0x1B, 0x2B, 0x20, 0x70, 0x0F, 0x1B, 0x7D}},
    /* 64 */ {16, {0x1B, 0x28, 0x32, 0x1B, 0x29, 0x33, 0x1B, 0x2A, 0x35, 0x1B, 0x2B, 0x20, 0x70, 0x0F, 0x1B, 0x7D}},
    /* 65 */ {17, {0x1B, 0x28, 0x32, 0x1B, 0x29, 0x20, 0x41, 0x1B, 0x2A, 0x35, 0x1B, 0x2B, 0x20, 0x70, 0x0F, 0x1B, 0x7D}},
    /* 66 */ {19, {0x1B, 0x28, 0x20, 0x41, 0x1B, 0x29, 0x20, 0x42, 0x1B, 0x2A, 0x20, 0x43, 0x1B, 0x2B, 0x20, 0x70, 0x0F, 0x1B, 0x7D}},
    /* 67 */ {19, {0x1B, 0x28, 0x20, 0x44, 0x1B, 0x29, 0x20, 0x45, 0x1B, 0x2A, 0x20, 0x46, 0x1B, 0x2B, 0x20, 0x70, 0x0F, 0x1B, 0x7D}},
    /* 68 */ {19, {0x1B, 0x28, 0x20, 0x47, 0x1B, 0x29, 0x20, 0x48, 0x1B, 0x2A, 0x20, 0x49, 0x1B, 0x2B, 0x20, 0x70, 0x0F, 0x1B, 0x7D}},
    /* 69 */ {19, {0x1B, 0x28, 0x20, 0x4A, 0x1B, 0x29, 0x20, 0x4B, 0x1B, 0x2A, 0x20, 0x4C, 0x1B, 0x2B, 0x20, 0x70, 0x0F, 0x1B, 0x7D}},
    /* 6A */ {19, {0x1B, 0x28, 0x20, 0x4D, 0x1B, 0x29, 0x20, 0x4E, 0x1B, 0x2A, 0x20, 0x4F, 0x1B, 0x2B, 0x20, 0x70, 0x0F, 0x1B, 0x7D}},
    /* 6B */ {17, {0x1B, 0x24, 0xF1, 0x1B, 0x29, 0x20, 0x42, 0x1B, 0x2A, 0x30, 0x1B, 0x2B, 0x20, 0x70, 0x0F, 0x1B, 0x7D}},
    /* 6C */ {17, {0x1B, 0x24, 0xF1, 0x1B, 0x29, 0x20, 0x43, 0x1B, 0x2A, 0x30, 0x1B, 0x2B, 0x20, 0x70, 0x0F, 0x1B, 0x7D}},
    /* 6D */ {17, {0x1B, 0x24, 0xF1, 0x1B, 0x29, 0x20, 0x44, 0x1B, 0x2A, 0x30, 0x1B, 0x2B, 0x20, 0x70, 0x0F, 0x1B, 0x7D}},
    /* 6E */ {16, {0x1B, 0x28, 0x31, 0x1B, 0x29, 0x30, 0x1B, 0x2A, 0x4A, 0x1B, 0x2B, 0x20, 0x70, 0x0F, 0x1B, 0x7D}},
    /* 6F */ {17, {0x1B, 0x28, 0x4A, 0x1B, 0x29, 0x32, 0x1B, 0x2A, 0x20, 0x41, 0x1B, 0x2B, 0x20, 0x70, 0x0F, 0x1B, 0x7D}},
};